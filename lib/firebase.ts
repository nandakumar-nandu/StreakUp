 ...
 * 
 * Initializes the Firebase client app, Authentication service, and Firestore database.
...
// Initialize Firebase App (avoid double initialization on hot reloads)
...
// Initialize Firestore with local persistent cache enabled for offline support
